...
#conda activate /home/lveeramacheneni/lconda_env
#echo Modules loaded....
/home/lveeramacheneni/lconda_env/bin/python /home/lveeramacheneni/network-compression/src/small_mnist_compression/mnist.py --lr=1e-3 --epochs=30 --mode=1 --optimizer=1 --compress_rate=75
