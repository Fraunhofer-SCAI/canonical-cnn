...
class CPNorm(object):
    ...
    def compute_Weight(self, module: Module) -> Any:
        ...
        recons_weight = tl.cp_to_tensor((weights, factors))
    ...
    def apply(module, name: str, rank : int, max_iter : int):
        ...
        factors = parafac(weight_tensor, rank= rank, init='random', random_state = 0,n_iter_max = max_iter, normalize_factors = True, linesearch = True)
